...
import {
  ...
  resolveCategoryVariantFromName,
...
export function BookingCategoryBadge({
  ...
  const resolvedVariant = variant ?? (categoryName ? resolveCategoryVariantFromName(categoryName) : undefined);
  const isContainer = resolvedVariant ? isContainerizedBondedCategory(resolvedVariant) : false;
  ...
  if (resolvedVariant === "import_container") {
    return (
  ...
  if (resolvedVariant === "export_container") {
    return (
  ...
  if (resolvedVariant === "empty_container") {
    return (
  ...
  if (resolvedVariant === "export_non_container") {
    return (
  ...
  if (resolvedVariant === "import_non_container") {
    return (
